      ...
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          <div class="flex shrink-0 items-center">
            <img @click.prevent="goTo(page.home)" class="h-8 w-auto cursor-pointer" src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=500"
              alt="Your Company" />
          </div>
          <div class="hidden sm:ml-6 sm:block">
            <div class="flex space-x-4">
              <div v-for="item in navigation" :key="item.name" @click.prevent="goTo(item.name)"
        ...
        <div class="py-6 pr-4">
          <div @click.prevent="goTo(page.login)" class="block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-[#ffff] cursor-pointer">
            Log in
          </div>
        </div>
      </div>
